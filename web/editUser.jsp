    ...
    <head>
        ...
        <script>
            function myFunction()
            {
                ...
                document.getElementById("firstName").value = '${editUser.getFirstName()}';
                document.getElementById("lastName").value = '${editUser.getLastName()}';
                document.getElementById("email").value = '${editUser.getEmail()}';
                document.getElementById("pword").value = '${editUser.getPassword()}';
                document.getElementById("address").value = '${editUser.getAddressLineOne()}';
                document.getElementById("address2").value = '${editUser.getAddressLineTwo()}';
                document.getElementById("state").value = '${editUser.getCounty()}';
                document.getElementById("country").value = '${editUser.getCountry()}';
                document.getElementById("postCode").value = '${editUser.getPostalCode()}';
                document.getElementById("userType").value = '${editUser.getUserType()}';
                if(${editUser.getIsDiasbled() == true}){
