...
<html>
    <head>
        ...
        <script>
            //funtion to search table based on product name
            function myFunction() {
                // Declare variables
    ...
    <body>
        ...
        <nav class="navbar navbar-dark fixed-top navbar-default  flex-md-nowrap p-0 shadow">
            <span class="navbar-brand col-sm-3 col-md-2 mr-0">Soft Bambino</span>
                                ...
                                <tbody>
                                    <c:forEach items="${SKALLPRODUCTS}" var="tempProduct">  
                                        ...
                                        <tr>
                                            ...
                                            <td>${tempProduct.getProductType()}</td>
                                            <td>${tempProduct.getStock()}</td>
                                            <td class="text-center"><a href="ProductManagerServlet?action=EDIT&id=${tempProduct.getId()}" class="text-dark"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                            <td class="text-center"><a href="" class="text-dark"><i class="fa fa-plus" aria-hidden="true"></i></a></td>
                                        <td class="text-center"><a href="ProductManagerServlet?action=DELETE&id=${tempProduct.getId()}" class="text-dark"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
